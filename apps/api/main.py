...
app = FastAPI(title="Discord Commerce API", version="0.6.0")
...
class CartItemIn(BaseModel):
    product_id: UUID; quantity: int = Field(gt=0, le=10000)
class CheckoutIn(BaseModel):
    idempotency_key: str = Field(min_length=8, max_length=128); coupon_code: str | None = Field(default=None, min_length=2, max_length=64); affiliate_code: str | None = Field(default=None, min_length=2, max_length=64)
class PaymentIn(BaseModel):
    order_id: UUID; payer_email: str = Field(min_length=5, max_length=320); idempotency_key: str = Field(min_length=8, max_length=128)
class RefundIn(BaseModel):
    amount_minor: int | None = Field(default=None, gt=0); idempotency_key: str = Field(min_length=8, max_length=128); reason: str | None = Field(default=None, max_length=500)
